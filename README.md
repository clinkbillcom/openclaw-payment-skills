...
```
@Claw 帮我安装 Clink 支付 Skill：https://github.com/openclaw/skills/tree/main/skills/agent-payment-skills
```

或使用斜杠命令：

```
/skill install https://github.com/openclaw/skills/tree/main/skills/agent-payment-skills
```
